 ...
 */
package miscontroles.micontrol;
...
public class MiControlBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( miscontroles.micontrol.MiControl.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleHelp] = new PropertyDescriptor ( "accessibleHelp", miscontroles.micontrol.MiControl.class, "getAccessibleHelp", "setAccessibleHelp" ); // NOI18N
            properties[PROPERTY_accessibleRole] = new PropertyDescriptor ( "accessibleRole", miscontroles.micontrol.MiControl.class, "getAccessibleRole", "setAccessibleRole" ); // NOI18N
            properties[PROPERTY_accessibleRoleDescription] = new PropertyDescriptor ( "accessibleRoleDescription", miscontroles.micontrol.MiControl.class, "getAccessibleRoleDescription", "setAccessibleRoleDescription" ); // NOI18N
            properties[PROPERTY_accessibleText] = new PropertyDescriptor ( "accessibleText", miscontroles.micontrol.MiControl.class, "getAccessibleText", "setAccessibleText" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", miscontroles.micontrol.MiControl.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_baselineOffset] = new PropertyDescriptor ( "baselineOffset", miscontroles.micontrol.MiControl.class, "getBaselineOffset", null ); // NOI18N
            properties[PROPERTY_blendMode] = new PropertyDescriptor ( "blendMode", miscontroles.micontrol.MiControl.class, "getBlendMode", "setBlendMode" ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", miscontroles.micontrol.MiControl.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_boundsInLocal] = new PropertyDescriptor ( "boundsInLocal", miscontroles.micontrol.MiControl.class, "getBoundsInLocal", null ); // NOI18N
            properties[PROPERTY_boundsInParent] = new PropertyDescriptor ( "boundsInParent", miscontroles.micontrol.MiControl.class, "getBoundsInParent", null ); // NOI18N
            properties[PROPERTY_cache] = new PropertyDescriptor ( "cache", miscontroles.micontrol.MiControl.class, "isCache", "setCache" ); // NOI18N
            properties[PROPERTY_cacheHint] = new PropertyDescriptor ( "cacheHint", miscontroles.micontrol.MiControl.class, "getCacheHint", "setCacheHint" ); // NOI18N
            properties[PROPERTY_cacheShape] = new PropertyDescriptor ( "cacheShape", miscontroles.micontrol.MiControl.class, "isCacheShape", "setCacheShape" ); // NOI18N
            properties[PROPERTY_centerShape] = new PropertyDescriptor ( "centerShape", miscontroles.micontrol.MiControl.class, "isCenterShape", "setCenterShape" ); // NOI18N
            properties[PROPERTY_childrenUnmodifiable] = new PropertyDescriptor ( "childrenUnmodifiable", miscontroles.micontrol.MiControl.class, "getChildrenUnmodifiable", null ); // NOI18N
            properties[PROPERTY_clip] = new PropertyDescriptor ( "clip", miscontroles.micontrol.MiControl.class, "getClip", "setClip" ); // NOI18N
            properties[PROPERTY_contentBias] = new PropertyDescriptor ( "contentBias", miscontroles.micontrol.MiControl.class, "getContentBias", null ); // NOI18N
            properties[PROPERTY_cssMetaData] = new PropertyDescriptor ( "cssMetaData", miscontroles.micontrol.MiControl.class, "getCssMetaData", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", miscontroles.micontrol.MiControl.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_depthTest] = new PropertyDescriptor ( "depthTest", miscontroles.micontrol.MiControl.class, "getDepthTest", "setDepthTest" ); // NOI18N
            properties[PROPERTY_disable] = new PropertyDescriptor ( "disable", miscontroles.micontrol.MiControl.class, "isDisable", "setDisable" ); // NOI18N
            properties[PROPERTY_disabled] = new PropertyDescriptor ( "disabled", miscontroles.micontrol.MiControl.class, "isDisabled", null ); // NOI18N
            properties[PROPERTY_effect] = new PropertyDescriptor ( "effect", miscontroles.micontrol.MiControl.class, "getEffect", "setEffect" ); // NOI18N
            properties[PROPERTY_effectiveNodeOrientation] = new PropertyDescriptor ( "effectiveNodeOrientation", miscontroles.micontrol.MiControl.class, "getEffectiveNodeOrientation", null ); // NOI18N
            properties[PROPERTY_eventDispatcher] = new PropertyDescriptor ( "eventDispatcher", miscontroles.micontrol.MiControl.class, "getEventDispatcher", "setEventDispatcher" ); // NOI18N
            properties[PROPERTY_focused] = new PropertyDescriptor ( "focused", miscontroles.micontrol.MiControl.class, "isFocused", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", miscontroles.micontrol.MiControl.class, "isFocusTraversable", "setFocusTraversable" ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", miscontroles.micontrol.MiControl.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hover] = new PropertyDescriptor ( "hover", miscontroles.micontrol.MiControl.class, "isHover", null ); // NOI18N
            properties[PROPERTY_id] = new PropertyDescriptor ( "id", miscontroles.micontrol.MiControl.class, "getId", "setId" ); // NOI18N
            properties[PROPERTY_impl_traversalEngine] = new PropertyDescriptor ( "impl_traversalEngine", miscontroles.micontrol.MiControl.class, "getImpl_traversalEngine", "setImpl_traversalEngine" ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", miscontroles.micontrol.MiControl.class, "getInputMethodRequests", "setInputMethodRequests" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", miscontroles.micontrol.MiControl.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_layoutBounds] = new PropertyDescriptor ( "layoutBounds", miscontroles.micontrol.MiControl.class, "getLayoutBounds", null ); // NOI18N
            properties[PROPERTY_layoutX] = new PropertyDescriptor ( "layoutX", miscontroles.micontrol.MiControl.class, "getLayoutX", "setLayoutX" ); // NOI18N
            properties[PROPERTY_layoutY] = new PropertyDescriptor ( "layoutY", miscontroles.micontrol.MiControl.class, "getLayoutY", "setLayoutY" ); // NOI18N
            properties[PROPERTY_localToParentTransform] = new PropertyDescriptor ( "localToParentTransform", miscontroles.micontrol.MiControl.class, "getLocalToParentTransform", null ); // NOI18N
            properties[PROPERTY_localToSceneTransform] = new PropertyDescriptor ( "localToSceneTransform", miscontroles.micontrol.MiControl.class, "getLocalToSceneTransform", null ); // NOI18N
            properties[PROPERTY_managed] = new PropertyDescriptor ( "managed", miscontroles.micontrol.MiControl.class, "isManaged", "setManaged" ); // NOI18N
            properties[PROPERTY_maxHeight] = new PropertyDescriptor ( "maxHeight", miscontroles.micontrol.MiControl.class, "getMaxHeight", "setMaxHeight" ); // NOI18N
            properties[PROPERTY_maxWidth] = new PropertyDescriptor ( "maxWidth", miscontroles.micontrol.MiControl.class, "getMaxWidth", "setMaxWidth" ); // NOI18N
            properties[PROPERTY_minHeight] = new PropertyDescriptor ( "minHeight", miscontroles.micontrol.MiControl.class, "getMinHeight", "setMinHeight" ); // NOI18N
            properties[PROPERTY_minWidth] = new PropertyDescriptor ( "minWidth", miscontroles.micontrol.MiControl.class, "getMinWidth", "setMinWidth" ); // NOI18N
            properties[PROPERTY_mouseTransparent] = new PropertyDescriptor ( "mouseTransparent", miscontroles.micontrol.MiControl.class, "isMouseTransparent", "setMouseTransparent" ); // NOI18N
            properties[PROPERTY_needsLayout] = new PropertyDescriptor ( "needsLayout", miscontroles.micontrol.MiControl.class, "isNeedsLayout", null ); // NOI18N
            properties[PROPERTY_nodeOrientation] = new PropertyDescriptor ( "nodeOrientation", miscontroles.micontrol.MiControl.class, "getNodeOrientation", "setNodeOrientation" ); // NOI18N
            properties[PROPERTY_onAction] = new PropertyDescriptor ( "onAction", miscontroles.micontrol.MiControl.class, "getOnAction", "setOnAction" ); // NOI18N
            properties[PROPERTY_onContextMenuRequested] = new PropertyDescriptor ( "onContextMenuRequested", miscontroles.micontrol.MiControl.class, "getOnContextMenuRequested", "setOnContextMenuRequested" ); // NOI18N
            properties[PROPERTY_onDragDetected] = new PropertyDescriptor ( "onDragDetected", miscontroles.micontrol.MiControl.class, "getOnDragDetected", "setOnDragDetected" ); // NOI18N
            properties[PROPERTY_onDragDone] = new PropertyDescriptor ( "onDragDone", miscontroles.micontrol.MiControl.class, "getOnDragDone", "setOnDragDone" ); // NOI18N
            properties[PROPERTY_onDragDropped] = new PropertyDescriptor ( "onDragDropped", miscontroles.micontrol.MiControl.class, "getOnDragDropped", "setOnDragDropped" ); // NOI18N
            properties[PROPERTY_onDragEntered] = new PropertyDescriptor ( "onDragEntered", miscontroles.micontrol.MiControl.class, "getOnDragEntered", "setOnDragEntered" ); // NOI18N
            properties[PROPERTY_onDragExited] = new PropertyDescriptor ( "onDragExited", miscontroles.micontrol.MiControl.class, "getOnDragExited", "setOnDragExited" ); // NOI18N
            properties[PROPERTY_onDragOver] = new PropertyDescriptor ( "onDragOver", miscontroles.micontrol.MiControl.class, "getOnDragOver", "setOnDragOver" ); // NOI18N
            properties[PROPERTY_onInputMethodTextChanged] = new PropertyDescriptor ( "onInputMethodTextChanged", miscontroles.micontrol.MiControl.class, "getOnInputMethodTextChanged", "setOnInputMethodTextChanged" ); // NOI18N
            properties[PROPERTY_onKeyPressed] = new PropertyDescriptor ( "onKeyPressed", miscontroles.micontrol.MiControl.class, "getOnKeyPressed", "setOnKeyPressed" ); // NOI18N
            properties[PROPERTY_onKeyReleased] = new PropertyDescriptor ( "onKeyReleased", miscontroles.micontrol.MiControl.class, "getOnKeyReleased", "setOnKeyReleased" ); // NOI18N
            properties[PROPERTY_onKeyTyped] = new PropertyDescriptor ( "onKeyTyped", miscontroles.micontrol.MiControl.class, "getOnKeyTyped", "setOnKeyTyped" ); // NOI18N
            properties[PROPERTY_onMouseClicked] = new PropertyDescriptor ( "onMouseClicked", miscontroles.micontrol.MiControl.class, "getOnMouseClicked", "setOnMouseClicked" ); // NOI18N
            properties[PROPERTY_onMouseDragEntered] = new PropertyDescriptor ( "onMouseDragEntered", miscontroles.micontrol.MiControl.class, "getOnMouseDragEntered", "setOnMouseDragEntered" ); // NOI18N
            properties[PROPERTY_onMouseDragExited] = new PropertyDescriptor ( "onMouseDragExited", miscontroles.micontrol.MiControl.class, "getOnMouseDragExited", "setOnMouseDragExited" ); // NOI18N
            properties[PROPERTY_onMouseDragged] = new PropertyDescriptor ( "onMouseDragged", miscontroles.micontrol.MiControl.class, "getOnMouseDragged", "setOnMouseDragged" ); // NOI18N
            properties[PROPERTY_onMouseDragOver] = new PropertyDescriptor ( "onMouseDragOver", miscontroles.micontrol.MiControl.class, "getOnMouseDragOver", "setOnMouseDragOver" ); // NOI18N
            properties[PROPERTY_onMouseDragReleased] = new PropertyDescriptor ( "onMouseDragReleased", miscontroles.micontrol.MiControl.class, "getOnMouseDragReleased", "setOnMouseDragReleased" ); // NOI18N
            properties[PROPERTY_onMouseEntered] = new PropertyDescriptor ( "onMouseEntered", miscontroles.micontrol.MiControl.class, "getOnMouseEntered", "setOnMouseEntered" ); // NOI18N
            properties[PROPERTY_onMouseExited] = new PropertyDescriptor ( "onMouseExited", miscontroles.micontrol.MiControl.class, "getOnMouseExited", "setOnMouseExited" ); // NOI18N
            properties[PROPERTY_onMouseMoved] = new PropertyDescriptor ( "onMouseMoved", miscontroles.micontrol.MiControl.class, "getOnMouseMoved", "setOnMouseMoved" ); // NOI18N
            properties[PROPERTY_onMousePressed] = new PropertyDescriptor ( "onMousePressed", miscontroles.micontrol.MiControl.class, "getOnMousePressed", "setOnMousePressed" ); // NOI18N
            properties[PROPERTY_onMouseReleased] = new PropertyDescriptor ( "onMouseReleased", miscontroles.micontrol.MiControl.class, "getOnMouseReleased", "setOnMouseReleased" ); // NOI18N
            properties[PROPERTY_onRotate] = new PropertyDescriptor ( "onRotate", miscontroles.micontrol.MiControl.class, "getOnRotate", "setOnRotate" ); // NOI18N
            properties[PROPERTY_onRotationFinished] = new PropertyDescriptor ( "onRotationFinished", miscontroles.micontrol.MiControl.class, "getOnRotationFinished", "setOnRotationFinished" ); // NOI18N
            properties[PROPERTY_onRotationStarted] = new PropertyDescriptor ( "onRotationStarted", miscontroles.micontrol.MiControl.class, "getOnRotationStarted", "setOnRotationStarted" ); // NOI18N
            properties[PROPERTY_onScroll] = new PropertyDescriptor ( "onScroll", miscontroles.micontrol.MiControl.class, "getOnScroll", "setOnScroll" ); // NOI18N
            properties[PROPERTY_onScrollFinished] = new PropertyDescriptor ( "onScrollFinished", miscontroles.micontrol.MiControl.class, "getOnScrollFinished", "setOnScrollFinished" ); // NOI18N
            properties[PROPERTY_onScrollStarted] = new PropertyDescriptor ( "onScrollStarted", miscontroles.micontrol.MiControl.class, "getOnScrollStarted", "setOnScrollStarted" ); // NOI18N
            properties[PROPERTY_onSwipeDown] = new PropertyDescriptor ( "onSwipeDown", miscontroles.micontrol.MiControl.class, "getOnSwipeDown", "setOnSwipeDown" ); // NOI18N
            properties[PROPERTY_onSwipeLeft] = new PropertyDescriptor ( "onSwipeLeft", miscontroles.micontrol.MiControl.class, "getOnSwipeLeft", "setOnSwipeLeft" ); // NOI18N
            properties[PROPERTY_onSwipeRight] = new PropertyDescriptor ( "onSwipeRight", miscontroles.micontrol.MiControl.class, "getOnSwipeRight", "setOnSwipeRight" ); // NOI18N
            properties[PROPERTY_onSwipeUp] = new PropertyDescriptor ( "onSwipeUp", miscontroles.micontrol.MiControl.class, "getOnSwipeUp", "setOnSwipeUp" ); // NOI18N
            properties[PROPERTY_onTouchMoved] = new PropertyDescriptor ( "onTouchMoved", miscontroles.micontrol.MiControl.class, "getOnTouchMoved", "setOnTouchMoved" ); // NOI18N
            properties[PROPERTY_onTouchPressed] = new PropertyDescriptor ( "onTouchPressed", miscontroles.micontrol.MiControl.class, "getOnTouchPressed", "setOnTouchPressed" ); // NOI18N
            properties[PROPERTY_onTouchReleased] = new PropertyDescriptor ( "onTouchReleased", miscontroles.micontrol.MiControl.class, "getOnTouchReleased", "setOnTouchReleased" ); // NOI18N
            properties[PROPERTY_onTouchStationary] = new PropertyDescriptor ( "onTouchStationary", miscontroles.micontrol.MiControl.class, "getOnTouchStationary", "setOnTouchStationary" ); // NOI18N
            properties[PROPERTY_onZoom] = new PropertyDescriptor ( "onZoom", miscontroles.micontrol.MiControl.class, "getOnZoom", "setOnZoom" ); // NOI18N
            properties[PROPERTY_onZoomFinished] = new PropertyDescriptor ( "onZoomFinished", miscontroles.micontrol.MiControl.class, "getOnZoomFinished", "setOnZoomFinished" ); // NOI18N
            properties[PROPERTY_onZoomStarted] = new PropertyDescriptor ( "onZoomStarted", miscontroles.micontrol.MiControl.class, "getOnZoomStarted", "setOnZoomStarted" ); // NOI18N
            properties[PROPERTY_opacity] = new PropertyDescriptor ( "opacity", miscontroles.micontrol.MiControl.class, "getOpacity", "setOpacity" ); // NOI18N
            properties[PROPERTY_opaqueInsets] = new PropertyDescriptor ( "opaqueInsets", miscontroles.micontrol.MiControl.class, "getOpaqueInsets", "setOpaqueInsets" ); // NOI18N
            properties[PROPERTY_padding] = new PropertyDescriptor ( "padding", miscontroles.micontrol.MiControl.class, "getPadding", "setPadding" ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", miscontroles.micontrol.MiControl.class, "getParent", null ); // NOI18N
            properties[PROPERTY_pickOnBounds] = new PropertyDescriptor ( "pickOnBounds", miscontroles.micontrol.MiControl.class, "isPickOnBounds", "setPickOnBounds" ); // NOI18N
            properties[PROPERTY_prefHeight] = new PropertyDescriptor ( "prefHeight", miscontroles.micontrol.MiControl.class, "getPrefHeight", "setPrefHeight" ); // NOI18N
            properties[PROPERTY_prefWidth] = new PropertyDescriptor ( "prefWidth", miscontroles.micontrol.MiControl.class, "getPrefWidth", "setPrefWidth" ); // NOI18N
            properties[PROPERTY_pressed] = new PropertyDescriptor ( "pressed", miscontroles.micontrol.MiControl.class, "isPressed", null ); // NOI18N
            properties[PROPERTY_properties] = new PropertyDescriptor ( "properties", miscontroles.micontrol.MiControl.class, "getProperties", null ); // NOI18N
            properties[PROPERTY_pseudoClassStates] = new PropertyDescriptor ( "pseudoClassStates", miscontroles.micontrol.MiControl.class, "getPseudoClassStates", null ); // NOI18N
            properties[PROPERTY_resizable] = new PropertyDescriptor ( "resizable", miscontroles.micontrol.MiControl.class, "isResizable", null ); // NOI18N
            properties[PROPERTY_rotate] = new PropertyDescriptor ( "rotate", miscontroles.micontrol.MiControl.class, "getRotate", "setRotate" ); // NOI18N
            properties[PROPERTY_rotationAxis] = new PropertyDescriptor ( "rotationAxis", miscontroles.micontrol.MiControl.class, "getRotationAxis", "setRotationAxis" ); // NOI18N
            properties[PROPERTY_scaleShape] = new PropertyDescriptor ( "scaleShape", miscontroles.micontrol.MiControl.class, "isScaleShape", "setScaleShape" ); // NOI18N
            properties[PROPERTY_scaleX] = new PropertyDescriptor ( "scaleX", miscontroles.micontrol.MiControl.class, "getScaleX", "setScaleX" ); // NOI18N
            properties[PROPERTY_scaleY] = new PropertyDescriptor ( "scaleY", miscontroles.micontrol.MiControl.class, "getScaleY", "setScaleY" ); // NOI18N
            properties[PROPERTY_scaleZ] = new PropertyDescriptor ( "scaleZ", miscontroles.micontrol.MiControl.class, "getScaleZ", "setScaleZ" ); // NOI18N
            properties[PROPERTY_scene] = new PropertyDescriptor ( "scene", miscontroles.micontrol.MiControl.class, "getScene", null ); // NOI18N
            properties[PROPERTY_shape] = new PropertyDescriptor ( "shape", miscontroles.micontrol.MiControl.class, "getShape", "setShape" ); // NOI18N
            properties[PROPERTY_snapToPixel] = new PropertyDescriptor ( "snapToPixel", miscontroles.micontrol.MiControl.class, "isSnapToPixel", "setSnapToPixel" ); // NOI18N
            properties[PROPERTY_style] = new PropertyDescriptor ( "style", miscontroles.micontrol.MiControl.class, "getStyle", "setStyle" ); // NOI18N
            properties[PROPERTY_styleableParent] = new PropertyDescriptor ( "styleableParent", miscontroles.micontrol.MiControl.class, "getStyleableParent", null ); // NOI18N
            properties[PROPERTY_styleClass] = new PropertyDescriptor ( "styleClass", miscontroles.micontrol.MiControl.class, "getStyleClass", null ); // NOI18N
            properties[PROPERTY_stylesheets] = new PropertyDescriptor ( "stylesheets", miscontroles.micontrol.MiControl.class, "getStylesheets", null ); // NOI18N
            properties[PROPERTY_transforms] = new PropertyDescriptor ( "transforms", miscontroles.micontrol.MiControl.class, "getTransforms", null ); // NOI18N
            properties[PROPERTY_translateX] = new PropertyDescriptor ( "translateX", miscontroles.micontrol.MiControl.class, "getTranslateX", "setTranslateX" ); // NOI18N
            properties[PROPERTY_translateY] = new PropertyDescriptor ( "translateY", miscontroles.micontrol.MiControl.class, "getTranslateY", "setTranslateY" ); // NOI18N
            properties[PROPERTY_translateZ] = new PropertyDescriptor ( "translateZ", miscontroles.micontrol.MiControl.class, "getTranslateZ", "setTranslateZ" ); // NOI18N
            properties[PROPERTY_typeSelector] = new PropertyDescriptor ( "typeSelector", miscontroles.micontrol.MiControl.class, "getTypeSelector", null ); // NOI18N
            properties[PROPERTY_userAgentStylesheet] = new PropertyDescriptor ( "userAgentStylesheet", miscontroles.micontrol.MiControl.class, "getUserAgentStylesheet", null ); // NOI18N
            properties[PROPERTY_userData] = new PropertyDescriptor ( "userData", miscontroles.micontrol.MiControl.class, "getUserData", "setUserData" ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", miscontroles.micontrol.MiControl.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", miscontroles.micontrol.MiControl.class, "getWidth", null ); // NOI18N
        }
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_onActionProperty111] = new MethodDescriptor(miscontroles.micontrol.MiControl.class.getMethod("onActionProperty", new Class[] {})); // NOI18N
