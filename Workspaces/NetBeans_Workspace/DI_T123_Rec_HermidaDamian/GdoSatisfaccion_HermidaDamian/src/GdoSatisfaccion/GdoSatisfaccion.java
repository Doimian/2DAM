...
public class GdoSatisfaccion extends VBox {
    ...
    @FXML
    final static Slider slider = new Slider(0,100,20);
    @FXML
    final static ProgressBar pBar = new ProgressBar(0);
    @FXML
    final static ProgressIndicator pInd = new ProgressIndicator(0);
